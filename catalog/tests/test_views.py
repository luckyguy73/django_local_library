...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        for book_copy in range(number_of_book_copies):
            return_date = timezone.localtime() + datetime.timedelta(days=book_copy % 7)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertFormError(response, 'form', 'renewal_date', 'Invalid date - renewal date given is in the past')
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertFormError(response, 'form', 'renewal_date', 'Invalid date - renewal date given is more than 4 weeks')
